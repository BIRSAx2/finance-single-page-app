<template>
  <div class="container">
    ...
    <p>
      ...
      <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Privacy Policy Generator</a>.
    </p>
    <h1 class="font-weight-bold">Interpretation and Definitions</h1>
    <h2 class="font-weight-bold">Interpretation</h2>
    <p>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Finance, accessible from
          <a href="https://finance-spa.herokuapp.com/" rel="external nofollow noopener" target="_blank"
            >https://finance-spa.herokuapp.com/</a
          >
        </p>
      </li>
      <li>
    ...
    <h1 class="font-weight-bold">Collecting and Using Your Personal Data</h1>
    <h2 class="font-weight-bold">Types of Data Collected</h2>
    <h3 class="font-weight-bold">Personal Data</h3>
    <p>
    ...
    <h3 class="font-weight-bold">Usage Data</h3>
    ...
    <h3 class="font-weight-bold">Tracking Technologies and Cookies</h3>
    <p>
    ...
    <ul>
      <li>
        <strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse
        all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts
      ...
      <li>
        ...
        information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as
        those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read &quot;Where can I change the
      ...
      <li>
        <strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons
    ...
    <p>
      ...
      device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies:
    ...
    <ul>
      <li>
        ...
        <p>
          Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of
          its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services
          that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.
        </p>
      </li>
      <li>
    ...
    <h2 class="font-weight-bold">Use of Your Personal Data</h2>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>To manage Your Account:</strong> to manage Your registration as a user of the Service. The Personal Data You provide can
          give You access to different functionalities of the Service that are available to You as a registered user.
        </p>
      </li>
      <li>
        <p>
          <strong>For the performance of a contract:</strong> the development, compliance and undertaking of the purchase contract for the
          products, items or services You have purchased or of any other contract with Us through the Service.
        </p>
      </li>
      <li>
        <p>
          <strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic
          communication, such as a mobile application's push notifications regarding updates or informative communications related to the
      ...
      <li>
        <p>
          <strong>To provide You</strong> with news, special offers and general information about other goods, services and events which we
      ...
      <li>
        <p>
          ...
          bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets
          transferred.
        </p>
      </li>
      <li>
        <p>
          <strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage
          trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services,
    ...
    <ul>
      <li>
        <strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the
      ...
      <li>
        ...
        negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another
        company.
      </li>
      <li>
        <strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require those affiliates
        to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other
        companies that We control or that are under common control with Us.
      </li>
      <li>
        <strong>With business partners:</strong> We may share Your information with Our business partners to offer You certain products,
        services or promotions.
      </li>
      <li>
        <strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users,
        such information may be viewed by all users and may be publicly distributed outside.
      </li>
      <li><strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</li>
    </ul>
    <h2 class="font-weight-bold">Retention of Your Personal Data</h2>
    <p>
    ...
    <h2 class="font-weight-bold">Transfer of Your Personal Data</h2>
    <p>
    ...
    <h2 class="font-weight-bold">Disclosure of Your Personal Data</h2>
    <h3 class="font-weight-bold">Business Transactions</h3>
    <p>
    ...
    <h3 class="font-weight-bold">Law enforcement</h3>
    <p>
    ...
    <h3 class="font-weight-bold">Other legal requirements</h3>
    ...
    <h2 class="font-weight-bold">Security of Your Personal Data</h2>
    <p>
    ...
    <h1 class="font-weight-bold">Children's Privacy</h1>
    <p>
    ...
    <h1 class="font-weight-bold">Links to Other Websites</h1>
    <p>
    ...
    <h1 class="font-weight-bold">Changes to this Privacy Policy</h1>
    <p>
    ...
    <ul>
      <li>By email: info@mouhieddine.dev</li>
    </ul>
  </div>
</template>
