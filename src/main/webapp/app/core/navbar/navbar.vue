<template>
  <b-navbar data-cy="navbar" toggleable="md" type="light" class="navbar navbar-expand-lg navbar-dark bg-primary">
    <b-navbar-brand class="logo" b-link to="/">
      <span class="logo-img"></span>
      <span class="navbar-title">Finance</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item to="/wallet" v-if="authenticated">
        ...
        <b-nav-item to="/transaction" v-if="authenticated">
