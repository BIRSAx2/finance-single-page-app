<template>
  <div>
    <PieChart v-if="incomeSources.length != 0" :chart-data="chartData" :options="options" />
...
export default class RevenueSources extends Vue {
  ...
  public retrieveAllTransactions(): void {
    ...
    this.transactionService()
      .retrieveRevenueSources(this.year)
      .then(
        res => {
          this.incomeSources = res.data.map(el => el.amount);
          this.chartData = {
