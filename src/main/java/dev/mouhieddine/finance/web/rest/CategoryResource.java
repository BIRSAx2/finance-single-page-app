...
import dev.mouhieddine.finance.service.CategoryService;
...
/**
 * REST controller for managing {@link dev.mouhieddine.finance.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    public ResponseEntity<CategoryDTO> updateCategory(
        ...
        if (
            ...
            !categoryService.findOne(id).get().getUser().getLogin().equals(SecurityUtils.getCurrentUserLogin().get())
        ) {
    ...
    public List<CategoryDTO> getAllCategories() {
        ...
        return categoryService.findByUserIsCurrentUser();
    }
    ...
    public ResponseEntity<CategoryDTO> getCategory(@PathVariable Long id) {
        ...
        if (categoryDTO.isPresent()) {
            if (!categoryDTO.get().getUser().getLogin().equals(SecurityUtils.getCurrentUserLogin().get())) {
                throw new BadRequestAlertException("Entity not found", ENTITY_NAME, "idnotfound");
            }
        }
